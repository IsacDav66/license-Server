...
class Webhook {
    constructor(rawJson) {
        ...
        else if (this.isType(types_1.WebhookType.VALIDATION_WEBHOOK)) {
            this._subject = {};
        }
    }
    /**
    ...
    static parse(webhookJsonStr, headers) {
        ...
        const typeObj = (0, types_1.getWebhookType)(webhookType);
        if (!typeObj) {
    ...
    isStatusComplete() {
        ...
        return statusId === types_1.WebhookStatus.COMPLETE;
    }
}
