...
exports.TebexProject = void 0;
const basketFacade_1 = require("../basketFacade");
...
class TebexProject {
     ...
     * @throws ApiException
     */
    async createBasket(completeUrl, cancelUrl, userIdentifier = '', includedCreationData = {}) {
        ...
        if (this.getUserIdentifierParameter()) {
            if (!userIdentifier) {
                throw new Error(`User identifier is required for this store type as: '${this.getUserIdentifierParameter()}'`);
            }
        ...
        for (const requiredParam of this.getRequiredBasketParams()) {
            ...
            if (!createBasketData[requiredParam]) {
                throw new Error(`Required parameter '${requiredParam}' is missing from the basket creation data.`);
            }
        }
        ...
        for (const [key, value] of Object.entries(includedCreationData)) {
            if (!createBasketData[key]) {
                ...
                throw new Error(`The key '${key}' is already set in the basket creation data.`);
            }
        }
        ...
        let basket = await tebex_1.Tebex.headless.createBasket(createBasketData);
        return new basketFacade_1.BasketFacade(basket, this);
    }
    /**
     ...
     */
    getUsernameFieldId(platformType) {
        switch (platformType) {
     ...
     * @throws ApiException
     */
    async getUserAuthUrl(wrapper, returnUrl) {
        return tebex_1.Tebex.headless.getUserAuthUrl(wrapper.getBasket(), returnUrl);
    }
    /**
     ...
     */
    async listPackages() {
        return await tebex_1.Tebex.headless.getAllPackages();
    }
    /**
    ...
    async listCategories() {
        return await tebex_1.Tebex.headless.getAllCategories();
    }
    /**
    ...
    async getCategory(categoryId) {
        return await tebex_1.Tebex.headless.getCategory(categoryId);
    }
    /**
    ...
    async getPackage(packageId) {
        return await tebex_1.Tebex.headless.getPackage(packageId);
    }
}
exports.TebexProject = TebexProject;
