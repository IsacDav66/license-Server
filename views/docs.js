const renderDocs = () => {
    ...
    <head>
        ...
        <meta property="og:title" content="StunBot | Documentación Técnica">
        <meta property="og:description" content="Guía avanzada sobre el funcionamiento, seguridad y protocolos del sistema StunBot.">
